#!/usr/bin/env python3
"""Dataset class for the pt-to-en TED corpus with a TensorFlow encoder."""
import transformers
...
class Dataset:
    """Loads, tokenizes and tf-encodes the pt-to-en TED dataset."""

    def __init__(self):
        """Load the splits, train the tokenizers and tf-encode the data."""
