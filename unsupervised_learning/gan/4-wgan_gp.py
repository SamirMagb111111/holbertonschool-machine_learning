...
class WGAN_GP(keras.Model):
    ...
    Same behaviour as the WGAN-GP of task 2, with an extra ``replace_weights``
    method able to load pre-trained generator and discriminator weights from
    two ``.h5`` files.
    """
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """Load generator and discriminator weights from two .h5 files."""
